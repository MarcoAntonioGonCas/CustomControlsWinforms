...
namespace MaControllers.Helpers
{
    ...
    {
        /// <summary>
        /// Convierte un valor numérico entero con rango en un nuevo rango.
        /// </summary>
        ...
        public static int ConvertTo(int minValue,int maxValue,int newMinValue,int newMaxValue,int value)
        {
